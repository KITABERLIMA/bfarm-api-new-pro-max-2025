...
@section('content')
	<h4 class="mb-4 py-3"><span class="text-muted fw-light">UI elements /</span> Toasts</h4>
	...
	<div class="bs-toast toast toast-placement-ex m-2" role="alert" aria-live="assertive"
		...
		<div class="toast-header">
			...
			<div class="fw-medium me-auto">Bootstrap</div>
	...
	<div class="card mb-4">
		...
		<div class="row g-0">
			...
			<div class="col-md-6 ui-bg-overlay-container p-4">
				...
				<div class="small fw-medium mb-3 text-white">Translucent</div>
